...
public class MorbiusDataProcessor implements ItemProcessor<MovieReviewsInput, MovieReviews> {

	private static final Logger log = LoggerFactory.getLogger(MorbiusDataProcessor.class);
	  //int id = 2965;
	  ...
	  public MovieReviews process(final MovieReviewsInput movieReviewsInput) throws Exception {
		  ...
		  DateTimeFormatter df = DateTimeFormatter.ofPattern("yyyy-MM-dd");
		  	...
		  	movieReviews.setMovieName("Morbius");
