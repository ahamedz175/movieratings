...
public class AvengersEndgameDataProcessor implements ItemProcessor<MovieReviewsInput, MovieReviews> {

	private static final Logger log = LoggerFactory.getLogger(AvengersEndgameDataProcessor.class);
	  //int id = 2965;
	  ...
	  public MovieReviews process(final MovieReviewsInput movieReviewsInput) throws Exception {
		  ...
		  DateTimeFormatter df = DateTimeFormatter.ofPattern("yyyy-MM-dd");
		  	...
		  	movieReviews.setMovieName("AvengersEndgame");
