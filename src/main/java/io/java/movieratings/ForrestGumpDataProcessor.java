...
public class ForrestGumpDataProcessor implements ItemProcessor<MovieReviewsInput, MovieReviews> {

	private static final Logger log = LoggerFactory.getLogger(ForrestGumpDataProcessor.class);
	  //int id = 1;
	  ...
	  public MovieReviews process(final MovieReviewsInput movieReviewsInput) throws Exception {
		 ...
		 // movieReviews.setId(movieReviewsInput.getId());
		  	...
		  	movieReviews.setMovieName("ForrestGump");
