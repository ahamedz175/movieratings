...
public class SpidermanDataProcessor implements ItemProcessor<MovieReviewsInput, MovieReviews> {

	private static final Logger log = LoggerFactory.getLogger(SpidermanDataProcessor.class);
	  //int id = 2965;
	  ...
	  public MovieReviews process(final MovieReviewsInput movieReviewsInput) throws Exception {
		  ...
		  DateTimeFormatter df = DateTimeFormatter.ofPattern("yyyy-MM-dd");
		  	...
		  	movieReviews.setMovieName("Spiderman");
